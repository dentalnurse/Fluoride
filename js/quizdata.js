const QUIZ_DATA = {
  ...
  2: { // Patient Assessment and Communication
    ...
    questions: [
      ...
      { q: "What does 'Gillick competence' refer to?", options: ["A child's right to refuse treatment completely", "A child's ability to consent independently if they have sufficient understanding", "A legal ruling about adult consent", "A GDC principle about communication"], correct: 1 },
      { q: "Which communication technique is recommended for anxious young children?", options: ["Rapid application without explanation", "Tell-show-do", "Verbal explanation only", "Written consent forms only"], correct: 1 },
      { q: "When must consent be re-obtained for fluoride varnish application?", options: ["Only at the first appointment", "Every 6 months", "At each appointment", "When the patient turns 16"], correct: 2 },
      { q: "What is the correct positioning technique for applying fluoride varnish to a very young pre-school child?", options: ["Standing position", "Knee-to-knee technique with parent", "Lying flat without parent present", "Sitting upright alone"], correct: 1 },
      { q: "A parent declines fluoride varnish for their child. What should you do?", options: ["Apply it anyway as it is in the child's best interests", "Provide accurate information, respect the decision, document and inform the dentist", "Refer to social services immediately", "Apply half a dose as a compromise"], correct: 1 },
      ...
      { q: "A teenager presents for fluoride varnish. Their parent is not present. What should you consider?", options: ["Refuse treatment until a parent is present", "Whether the young person is Gillick competent to consent independently", "Apply fluoride and inform the parent later", "Only apply to posterior teeth"], correct: 1 },
    ]
  },
  ...
  4: { // Professional Responsibilities and Law
    ...
    questions: [
      ...
      { q: "What does the Mental Capacity Act 2005 require before treating a patient who lacks capacity?", options: ["Written consent from any family member", "Treatment must be in the patient's best interests", "Treatment must be refused", "A court order must be obtained"], correct: 1 },
      { q: "For an adult's dental records, what is the minimum retention period?", options: ["5 years from last entry", "7 years from last entry", "11 years from last entry", "20 years from last entry"], correct: 2 },
      { q: "The GDC Scope of Practice (November 2025) states that dental nurses may apply fluoride varnish provided they are:", options: ["Under direct supervision at all times permanently", "Trained, competent and indemnified", "Working only in NHS practices", "Employed by a dentist"], correct: 1 },
      { q: "Which of the following best describes the NHS Amendment Regulations 2026 in relation to fluoride varnish?", options: ["They banned dental nurses from applying fluoride varnish", "They formally recognised standalone fluoride varnish by a dental nurse as an NHS course of treatment", "They required all dental nurses to pass a written exam", "They restricted fluoride varnish to children only"], correct: 1 },
      { q: "What does COSHH stand for?", options: ["Control of Substances Hazardous to Health", "Clinical Obligations for Safe Health Handling", "Control of Sterilisation and Health Hazards", "Certificate of Standard Health and Hygiene"], correct: 0 },
      { q: "Under COSHH, what must be in place before using fluoride varnish in practice?", options: ["A signed agreement from every patient", "A COSHH risk assessment for the fluoride product", "A specific fluoride varnish licence", "GDC approval for each product used"], correct: 1 },
      { q: "Which of the following is a GDC registrant's duty when they believe a patient may be at risk?", options: ["Keep the concern to themselves", "Raise the concern appropriately", "Refuse to treat the patient", "Report only if asked by the dentist"], correct: 1 },
      { q: "What is the minimum requirement for dental records under the Health and Social Care Act 2008?", options: ["Records must be printed and stored physically", "Records must be accurate, complete and kept securely", "Records only need to be kept for 1 year", "Records must be signed by a dentist"], correct: 1 },
